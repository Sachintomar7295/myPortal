...
const Home = ({ setActive, user, active }) => {
  ...
  const updateState = (docSnapshot) => {
    ...
    if (!isCollectionEmpty) {
      ...
      toast.info("No more Journals to display");
      setHide(true);
    }
  };
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure wanted to delete the Journal ?")) {
      try {
        setLoading(true);
      ...
      <div className="container padding">
        <div className="row mx-0">
          ...
          <div className="col-md-8">
            <div className="blog-heading text-start py-2 mb-4">JOURNALS</div>
            {blogs.length === 0 && location.pathname !== "/" && (
              <>
                <h4>
                  No Journal found with search keyword:{" "}
          ...
          <div className="col-md-3">
            ...
            <Tags tags={tags} />
            <FeatureBlogs title={"MOST POPULAR JOURNALS"} blogs={blogs} />
